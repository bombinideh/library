...
__export(shelfs_exports, {
  shelfsGetManyValidation: () => shelfsGetManyValidation,
  shelfsGetOneValidation: () => shelfsGetOneValidation,
  shelfsPatchOneValidation: () => shelfsPatchOneValidation,
  shelfsPostOneValidation: () => shelfsPostOneValidation
});
module.exports = __toCommonJS(shelfs_exports);
var import_joi = __toESM(require("joi"));
var shelfsPostOneValidation = import_joi.default.object({
  name: import_joi.default.string().required(),
  bookcase_id: import_joi.default.number().required()
});
var shelfsGetManyValidation = import_joi.default.object({
  bookcase_id: import_joi.default.string()
});
var shelfsGetOneValidation = import_joi.default.object({
  shelf_id: import_joi.default.number().required()
});
var shelfsPatchOneValidation = import_joi.default.object({
